 ...
 */
final class Version20210205162227 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE button_plant DROP final_sheet_id_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE button_plant ADD final_sheet_id_id INT DEFAULT NULL');
